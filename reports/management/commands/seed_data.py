...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        reports = [
            ...
            {
                "user": user,
                "title": "ayaw kulll bata paku kull",
                "category": SafetyReport.Category.OTHER,
                "description": "dili kol ayaw kulll bata pko kullll",
                "location_name": "Tiniguiban, Puerto Princesa",
                "latitude": 9.779430,
                "longitude": 118.736250,
                "risk_level": SafetyReport.RiskLevel.MEDIUM,
                "status": SafetyReport.Status.PENDING,
                "time_observed": time(9, 15),
                "lighting_condition": SafetyReport.LightingCondition.MODERATE,
                "crowd_level": SafetyReport.CrowdLevel.MODERATE,
            },
            {
                "user": user,
                "title": "Help meeeeeeeeeeeeeee, Wala akong pera",
                "category": SafetyReport.Category.OTHER,
                "description": "Pautang naman ohhhh.. baka lang naman",
                "location_name": "Tiniguiban, Puerto Princesa",
                "latitude": 9.779000,
                "longitude": 118.735100,
                "risk_level": SafetyReport.RiskLevel.HIGH,
                "status": SafetyReport.Status.PENDING,
                "time_observed": time(10, 45),
                "lighting_condition": SafetyReport.LightingCondition.MODERATE,
                "crowd_level": SafetyReport.CrowdLevel.CROWDED,
            },
            {
                ...
                "title": "ANO BA TO?",
                "category": SafetyReport.Category.ACCIDENT_PRONE,
                "description": "miss q na sya, wala man lang magawa ang sambayanan",
                "location_name": "Puerto Princesa South Road, Puerto Princesa",
                "latitude": 9.776400,
                "longitude": 118.735800,
                "risk_level": SafetyReport.RiskLevel.CRITICAL,
                "status": SafetyReport.Status.PENDING,
                "time_observed": time(12, 30),
                "lighting_condition": SafetyReport.LightingCondition.BRIGHT,
                "crowd_level": SafetyReport.CrowdLevel.CROWDED,
            },
            {
                "user": trusted,
                "title": "Unmarked crossing near barangay road",
                "category": SafetyReport.Category.NO_PEDESTRIAN_LANE,
                "description": "Pedestrians cross between tricycles and cars because the lane markings are faded.",
                "location_name": "Tiniguiban Barangay Road",
                "latitude": 9.780160,
                "longitude": 118.737030,
                "risk_level": SafetyReport.RiskLevel.HIGH,
                "status": SafetyReport.Status.VERIFIED,
                "time_observed": time(18, 5),
                "lighting_condition": SafetyReport.LightingCondition.DIM,
                "crowd_level": SafetyReport.CrowdLevel.MODERATE,
            },
            {
                "user": user,
                "title": "Sidewalk blocked by parked vehicles",
                "category": SafetyReport.Category.BROKEN_SIDEWALK,
                "description": "People are forced to walk on the road because several vehicles block the sidewalk.",
                "location_name": "San Jose Road, Puerto Princesa",
                "latitude": 9.782180,
                "longitude": 118.732980,
                "risk_level": SafetyReport.RiskLevel.MEDIUM,
                "status": SafetyReport.Status.IN_PROGRESS,
                "time_observed": time(15, 20),
                "lighting_condition": SafetyReport.LightingCondition.BRIGHT,
                "crowd_level": SafetyReport.CrowdLevel.CROWDED,
            },
            {
                "user": trusted,
                "title": "Unsafe shortcut behind commercial block",
                "category": SafetyReport.Category.UNSAFE_SHORTCUT,
                "description": "The shortcut has poor lighting and few people pass through after evening.",
                "location_name": "Commercial Block Shortcut",
                "latitude": 9.777920,
                "longitude": 118.734210,
                "risk_level": SafetyReport.RiskLevel.HIGH,
                "status": SafetyReport.Status.PENDING,
                "time_observed": time(21, 10),
                "lighting_condition": SafetyReport.LightingCondition.NO_LIGHT,
                "crowd_level": SafetyReport.CrowdLevel.EMPTY,
            },
            {
                "user": user,
                "title": "Harassment concern near waiting shed",
                "category": SafetyReport.Category.HARASSMENT_CONCERN,
                "description": "Several students reported uncomfortable encounters near the waiting shed at night.",
                "location_name": "Tiniguiban Waiting Shed",
                "latitude": 9.778220,
                "longitude": 118.736850,
                "risk_level": SafetyReport.RiskLevel.HIGH,
                "status": SafetyReport.Status.PENDING,
                "time_observed": time(20, 35),
                "lighting_condition": SafetyReport.LightingCondition.DIM,
                "crowd_level": SafetyReport.CrowdLevel.FEW,
            },
            {
                "user": trusted,
                "title": "Drainage cover missing near corner",
                "category": SafetyReport.Category.BROKEN_SIDEWALK,
                "description": "A missing drainage cover creates a tripping hazard for walkers, especially during rain.",
                "location_name": "Corner Road, Tiniguiban",
                "latitude": 9.780780,
                "longitude": 118.734980,
                "risk_level": SafetyReport.RiskLevel.MEDIUM,
                "status": SafetyReport.Status.VERIFIED,
                "time_observed": time(6, 50),
                "lighting_condition": SafetyReport.LightingCondition.MODERATE,
                "crowd_level": SafetyReport.CrowdLevel.FEW,
            },
        ]
